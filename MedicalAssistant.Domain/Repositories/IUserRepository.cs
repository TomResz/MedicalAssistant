...
{
	Task<User?> GetByEmailAsync(Email email, CancellationToken cancellationToken = default,bool hasQueryFilter = true);
	...
	Task<User?> GetByIdAsync(UserId userId, CancellationToken cancellationToken = default,bool ignoreQueryFilters = false);
