...
{
    [Parameter] public IReadOnlyList<VisitDto> Visits { get; set; }
    ...
    private async Task Add()
    {
        ...
        var options = new MudBlazor.DialogOptions() { CloseOnEscapeKey = true, FullWidth = true };
        var dialog = await DialogService.ShowAsync<CreateVisitDialog>(Translations.AddVisitTitle, parameters);
    }
    ...
    {
        var visit = _visits.FirstOrDefault(x => x.Id == visitId);
