...
public partial class MedicationWeekList
{
    ...
    [Parameter] public IReadOnlyList<MedicationWithDayDto> Medications { get; set; }

    [Parameter] public DateTime DateOfMonday { get; set; }

    [Parameter] public DateTime DateOfSunday { get; set; }
